...
L["config_tpplatforms"] = "Платформа телепортации"
L["config_tpplatforms_desc"] = "Показать местоположение платформы телепортации."
...
L["handler_tooltip_TNTIER"] = "Уровень %s сети путешествий(я)."
