...
L["config_greatvault"] = "Великое хранилище"
L["config_greatvault_desc"] = "Показать местонахождение великого хранилища."
...
L["config_picons_trainer_desc"] = "Показывать значки профессий для тренеров вместо значков тренеров."
L["config_picons_vendor_desc"] = "Показывать значки профессий для продавцов вместо значков продавцов."
