...
L["config_tpplatforms"] = "Plateforme de téléportation"
L["config_tpplatforms_desc"] = "Afficher les emplacements des plateformes de téléportation."
...
L["handler_tooltip_TNTIER"] = "Niveau %s du réseau de transport."
